...
bool flexran::app::scheduler::flexible_scheduler::remove_slice(uint64_t bs_id,
...
uint64_t flexran::app::scheduler::flexible_scheduler::parse_enb_agent_id(
    const std::string& enb_agent_id_s) const
{
  return rib_.parse_enb_agent_id(enb_agent_id_s);
}

uint64_t flexran::app::scheduler::flexible_scheduler::get_last_bs() const
{
