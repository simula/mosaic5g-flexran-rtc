...
int main(int argc, char* argv[]) {
  ...
  auto aqm_management = std::make_shared<flexran::app::management::aqm_management>(rib, rm, ev);
...
//#endif
  ...
  flexran::north_api::aqm_calls aqm_calls(aqm_management);
  north_api.register_calls(aqm_calls);
